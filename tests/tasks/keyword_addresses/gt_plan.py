...
def main() -> None:
    ...
    df = pd.read_csv("tests/tasks/datalake/adventure_works/Address_SEP_table_45.csv")[['AddressLine1']].copy()
    ...
    k = 50
    plan = Plan()
    plan.add("keyword", Seekers.Keyword(df['AddressLine1'].tolist(), k))
