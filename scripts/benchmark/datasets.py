...
DATASETS: dict[str, DatasetSpec] = {
    "adventure_works": DatasetSpec(
        ...
        contexts_jsonl_inside_zip="adventure/contexts_adventure.jsonl",
    ),
    "chembl": DatasetSpec(
        name="chembl",
        ...
        contexts_jsonl_inside_zip="chembl/contexts_chembl.jsonl",
    ),
    "public_bi": DatasetSpec(
        ...
        contexts_jsonl_inside_zip="public/contexts_public.jsonl",
    ),
    "chicago_open": DatasetSpec(
        ...
        contexts_jsonl_inside_zip="chicago/contexts_chicago.jsonl",
    ),
    "fetaqa": DatasetSpec(
        name="fetaqa",
        ...
        contexts_jsonl_inside_zip="fetaqa/contexts_fetaqa.jsonl",
    ),
}
